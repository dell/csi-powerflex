module github.com/dell/csi-powerflex/tests/e2e
...
require (
	...
	sigs.k8s.io/vsphere-csi-driver/v2 v2.5.0 // indirect
	sigs.k8s.io/yaml v1.3.0
)

require github.com/dell/csm-operator v0.0.0-00010101000000-000000000000
...
require (
	...
	k8s.io/sample-controller v0.21.1 // indirect
