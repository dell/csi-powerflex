...
* Pulling and saving container images
   ...
   dellemc/csi-powermax:v2.10
   dellemc/csi-powerstore:v2.10
   dellemc/csi-unity:v2.8.0
   dellemc/csi-vxflexos:v2.10
...
Loaded image: docker.io/dellemc/csi-powerstore:v2.10
Loaded image: docker.io/dellemc/csi-isilon:v2.10
...
...
...
* Tagging and pushing images
   ...
   dellemc/csi-isilon:v2.10 -> localregistry:5000/dell-csm-operator/csi-isilon:v2.10
...
* Preparing files within /root/dell-csm-operator-bundle
   ...
   changing: dellemc/csi-isilon:v2.10 -> localregistry:5000/dell-csm-operator/csi-isilon:v2.10
